const CACHE='mesaflow-v7';
const ASSETS=['./','./index.html','./styles.css?v=7','./js/config.js?v=7','./js/boot-v6.js?v=7','./v6.css.gz.b64?v=7','./js/app-v6.js.gz.b64?v=7','./manifest.webmanifest','./assets/grao-logo.svg'];
